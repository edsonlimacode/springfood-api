...
INSERT INTO public.cities (id,name,state_id) VALUES(1,'várzea alegre',1);
SELECT setval('cities_id_seq', (SELECT MAX(id) FROM cities));

INSERT INTO public.payments (id,description) VALUES (1,'Pix'),(2,'cartão de crédito/débito'),(3,'dinheiro'),(4,'Outro');
